...
| 发布模块 | `hzc-666-ai/moonpathfinding`（版本 `0.1.3`） |
...
3. CI 执行 `moon check`、`moon fmt --check`、`moon info`、`moon test`；74 个测试已在四后端验证，当前共 23 次提交。
4. 发布版本为 `hzc-666-ai/moonpathfinding@0.1.3`，预期交付物均已完成并可通过 README 命令复现。
